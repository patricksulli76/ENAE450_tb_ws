...
class DrivingNode(Node):
    ...
    def max_distances(self, msg):
        ...
        """
        ranges = msg.ranges[80:280]  # Get the range data from 90° to 270°
        ...
        for i, dist in enumerate(ranges):
            if np.isnan(dist):
                ...
                valid_pairs.append((i+80, 100.0))
            else:
                valid_pairs.append((i+80, dist))
    ...
    def follow_max(self, msg, movement_msg, max_distance):
        ...
        center_index = 180 # The center of our scan range (straight ahead)
    ...
    def check_viable_max(self, max_distances, msg):
        ...
        for idx, dist in max_distances:
            ...
            end_idx = min(idx+40, len(msg.ranges)-1)
